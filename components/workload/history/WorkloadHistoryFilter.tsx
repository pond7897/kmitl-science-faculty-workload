        ...
        <div className="flex flex-1 flex-col gap-[15px] sm:flex-row sm:items-end">
          <div className="flex flex-1 flex-col gap-[5px]">
            <label
              ...
              className="text-[14px] font-medium leading-5 text-[#160906]"
            >
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="h-12 w-full rounded-[10px] border border-[#E2E8F0] bg-white pl-[46px] pr-5 text-[14px] leading-none font-light text-[#160906] shadow-none placeholder:text-[14px] placeholder:leading-none placeholder:font-light placeholder:text-[#ACACAC] focus-visible:border-[#F27F0D] focus-visible:ring-2 focus-visible:ring-[#F27F0D]/15"
              />
            </div>
          </div>
